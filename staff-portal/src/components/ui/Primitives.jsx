...
export function StatusBadge({ s }) {
  return (
    <span className={cx("badge", badgeClass(s))}>
  ...
  return (
    <div className="stat">
      <div className="stat-top">
        <div
          className="stat-ico"
          style={{ background: tones[0], color: tones[1] }}
        >
          <Ico />
        </div>
        {delta && (
...
export function EmptyState({
  icon: Ico = CheckCircle2,
  title = "Nothing here yet",
  sub = "When records are available, they will appear here.",
}) {
  return (
    <div className="empty">
      <div className="eic">
...
export function LogoMark({ size = 26, mono }) {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none">
      ...
      <path
        d="M8 13.5L16 9l8 4.5-8 4.5-8-4.5Z"
        stroke="#fff"
        strokeWidth="1.8"
      ...
      />
      <path
        d="M11.5 15.3v4.4c0 1.4 2 2.6 4.5 2.6s4.5-1.2 4.5-2.6v-4.4"
        stroke="#fff"
        strokeWidth="1.8"
        strokeLinecap="round"
      />
