    ...
    >
      <div
        ...
        style={{
          ...
          borderRadius: 20,
          boxShadow:
            "0 32px 80px rgba(0,0,0,.7), 0 0 0 1px rgba(255,255,255,.05)",
          width: "100%",
          maxWidth: maxW,
        ...
        {title && (
          ...
          >
            ...
            <button
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.background = "var(--surface-4, #212634)";
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.background = "var(--surface-3, #191d27)";
              }}
            >
              <X size={15} />
            </button>
