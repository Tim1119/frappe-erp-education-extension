...
export const DOCTYPES = {
  ...
  student: {
    ...
    fields: [
      ...
      'date_of_birth', 'student_email_id', 'student_mobile_number',
      'student_applicant', 'image', 'enabled',
    ],
  },
  ...
  programEnrollment: {
    ...
    fields: [
      ...
      'academic_term', 'student_batch_name', 'enrollment_date',
    ],
  },
  studentGroup: {
    ...
    fields: [
      ...
      'academic_term', 'instructor', 'max_strength', 'disabled',
    ],
  },
  instructor: {
    doctype: 'Instructor',
  ...
  guardian: {
    doctype: 'Guardian',
    fields: ['name', 'guardian_name', 'email_address', 'mobile_number', 'occupation', 'education'],
  },
  studentAttendance: {
    doctype: 'Student Attendance',
    fields: [
      'name', 'student', 'student_name', 'student_group', 'course_schedule',
      'attendance_date', 'status', 'academic_year', 'academic_term',
    ],
  },
  assessmentGroup: {
  ...
  assessmentPlan: {
    ...
    fields: [
      'name', 'assessment_name', 'assessment_group', 'course', 'student_group',
      'grading_scale', 'maximum_assessment_score', 'supervisor',
    ],
  },
  assessmentResult: {
  ...
  courseSchedule: {
    ...
    fields: [
      'name', 'course', 'student_group', 'instructor', 'room',
  ...
  fees: {
    ...
    fields: [
      'name', 'student', 'student_name', 'program', 'academic_year',
      'grand_total', 'outstanding_amount', 'paid_amount', 'status', 'due_date',
    ],
  },

  paymentEntry: {
    doctype: 'Payment Entry',
    fields: ['name', 'party', 'paid_amount', 'posting_date', 'mode_of_payment', 'reference_no', 'status'],
  },
  ...
  employee: {
    doctype: 'Employee',
    fields: [
      'name', 'employee_name', 'department', 'designation', 'company_email',
      'status', 'date_of_joining', 'image',
    ],
  },
  ...
  leaveAllocation: {
    ...
    fields: ['name', 'employee', 'employee_name', 'leave_type', 'new_leaves_allocated', 'total_leaves_allocated'],
  },
