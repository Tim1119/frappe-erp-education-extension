                ...
                <tr key={guardian.name}>
                  ...
                  <td style={{ position: "relative" }}>
                    <button
                      className="iconbtn"
                      onClick={() =>
                        setMenuId(menuId === guardian.name ? null : guardian.name)
                      }
                    >
                      <MoreHorizontal size={16} />
                    </button>

                    {menuId === guardian.name && (
                      <div
                        className="rowmenu"
                        style={{
                          right: 0,
                      ...
                      >
                        <button
                          onClick={() =>
                            navigate(`/dashboard/guardians/${guardian.name}`)
                          }
                        >
                          <Eye size={16} />
                          View
                        ...
                        <button
                          onClick={() =>
                            navigate(`/dashboard/guardians/${guardian.name}/edit`)
                          }
                        >
                          <Pencil size={16} />
                          Edit
