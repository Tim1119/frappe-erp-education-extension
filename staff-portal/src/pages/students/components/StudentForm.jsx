      ...
      <SectionPanel icon={GraduationCap} title="Personal Information">
        <div className="grid-form">
          <div className="field">
            ...
            <input className="input" value={form.student_name} required onChange={(e) => updateField('student_name', e.target.value)} />
          </div>

          <div className="field">
            <Label required>First Name</Label>
            <input className="input" value={form.first_name} required onChange={(e) => updateField('first_name', e.target.value)} />
          </div>

          <div className="field">
            <Label>Middle Name</Label>
            <input className="input" value={form.middle_name} onChange={(e) => updateField('middle_name', e.target.value)} />
          </div>

          <div className="field">
            <Label required>Last Name</Label>
            <input className="input" value={form.last_name} required onChange={(e) => updateField('last_name', e.target.value)} />
          </div>

          <div className="field">
            <Label required>Gender</Label>
            <select className="select" value={form.gender} required onChange={(e) => updateField('gender', e.target.value)}>
          ...
          <div className="field">
            ...
            <input type="date" className="input" value={form.date_of_birth} required onChange={(e) => updateField('date_of_birth', e.target.value)} />
          </div>
          ...
          <div className="field">
            ...
            <input className="input" value={form.nationality} onChange={(e) => updateField('nationality', e.target.value)} />
          </div>

          <div className="field">
            <Label required>Email</Label>
            <input type="email" className="input" value={form.student_email_id} required onChange={(e) => updateField('student_email_id', e.target.value)} />
          </div>

          <div className="field">
            <Label required>Phone</Label>
            <input className="input" value={form.student_mobile_number} required onChange={(e) => updateField('student_mobile_number', e.target.value)} />
          </div>
        </div>
      </SectionPanel>
      ...
      <SectionPanel icon={MapPin} title="Address">
        <div className="grid-form">
          <div className="field">
            ...
            <input className="input" value={form.address_line_1} onChange={(e) => updateField('address_line_1', e.target.value)} />
          </div>

          <div className="field">
            <Label>Address Line 2</Label>
            <input className="input" value={form.address_line_2} onChange={(e) => updateField('address_line_2', e.target.value)} />
          </div>
          ...
          <div className="field">
            <Label>Pincode</Label>
            <input className="input" value={form.pincode} onChange={(e) => updateField('pincode', e.target.value)} />
          </div>
        </div>
      </SectionPanel>
