    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      <div className="panel" style={{ padding: 20 }}>
        <div style={{ display: 'flex', gap: 18, alignItems: 'center' }}>
          <Avatar name={student.student_name} src={student.image} size={64} round />
          <div>
            <div style={{ fontSize: 18, fontWeight: 650, letterSpacing: '-.01em' }}>
      ...
      <div className="panel">
        ...
        <div className="grid-3" style={{ padding: '4px 18px 20px' }}>
          ...
          <Item label="Date of Birth" value={student.date_of_birth ? fmtDate(student.date_of_birth) : null} />
      ...
      <div className="panel">
        ...
        {(student.guardians || []).length === 0 ? (
          <EmptyState icon={UsersIcon} title="No guardians linked" sub="Add a guardian from the Student record in Frappe Desk." />
        ) : (
          <table className="tbl">
            ...
            <tbody>
              {student.guardians.map((g, i) => (
                <tr key={i} className="row">
                  ...
                  <td className="muted2" style={{ fontSize: 13 }}>{g.relation || '—'}</td>
                </tr>
              ))}
            </tbody>
          </table>
