                ...
                <tr key={subject.name}>
                  ...
                  <td style={{ position: "relative" }}>
                    <button
                      className="iconbtn"
                      onClick={() =>
                        setMenuId(menuId === subject.name ? null : subject.name)
                      }
                    >
                    ...
                    {menuId === subject.name && (
                      ...
                      >
                        <button
                          onClick={() =>
                            navigate(
                              `/dashboard/subjects/${encodeURIComponent(subject.name)}`
                            )
                          }
                        >
                          <Eye size={16} />
                        ...
                        <button
                          onClick={() =>
                            navigate(
                              `/dashboard/subjects/${encodeURIComponent(subject.name)}/edit`
                            )
                          }
                        >
                          <Pencil size={16} />
