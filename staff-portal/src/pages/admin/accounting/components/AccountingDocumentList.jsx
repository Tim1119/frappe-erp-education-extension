...
const CONFIG = {
  ...
  Dunning: { eyebrow: "Accounting · Receivables · Dunning", columns: [["Customer", (r) => r.customer_name || r.customer], ["Dunning Type", (r) => r.dunning_type], ["Posting Date", (r) => fmtDate(r.posting_date)], ["Dunning Fee", (r) => money(r.dunning_fee)], ["Grand Total", (r) => money(r.grand_total)], ["Status", (r) => <DocumentStatusBadge doctype="Dunning" row={r} />]] },
  "Dunning Type": { eyebrow: "Accounting · Receivables · Dunning", columns: [["Dunning Type", (r) => r.dunning_type || r.name], ["Dunning Fee", (r) => money(r.dunning_fee)], ["Rate of Interest", (r) => (r.rate_of_interest ? `${r.rate_of_interest}%` : "—")], ["Company", (r) => r.company], ["Default", (r) => (r.is_default ? "Yes" : "No")]] },
