  ...
  return (
    <>
      <PageHeader
        eyebrow="People"
        title="Teachers"
        sub={loading ? "Loading…" : `${count} instructors`}
      />
      ...
      <Toolbar
        ...
        onCreate={() =>
          toast(
            "Create instructors from Frappe Desk, or wire the create form up next.",
          )
        }
          ...
          <tbody>
            {rows.map((t) => (
              ...
              >
                ...
                <td>
                  <StatusBadge
                    s={t.status === "Active" ? "ACTIVE" : "SUSPENDED"}
                  />
                </td>
              </tr>
            ))}
