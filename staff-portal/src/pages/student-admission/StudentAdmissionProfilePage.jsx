  ...
  return (
    <button
      ...
      style={{
        ...
        backgroundColor: "var(--surface-2)", border: "1px solid var(--border)", borderRadius: "6px",
  ...
  return (
    <>
      ...
      <div className="panel" style={{ marginBottom: 18 }}>
        <SectionHead
          icon={BookOpen}
          title="Eligibility and Programs"
          sub={`${(admission.program_details || []).length} programs`}
        />
        {(admission.program_details || []).length === 0 ? (
          <EmptyState icon={BookOpen} title="No programs" sub="Add programs from the edit form." />
        ) : (
          <table className="tbl">
            <thead>
              <tr>
