    ...
    <>
      ...
      <form onSubmit={handleSubmit}>
        <div className="panel" style={{ overflow: "visible" }}>
          ...
          <div style={{ display: "flex", gap: "20px", padding: "16px 20px", borderBottom: "1px solid var(--border)", alignItems: "center", flexWrap: "wrap" }}>
            <div style={{ width: "80px", height: "100px", borderRadius: "8px", border: "1px solid var(--border)", overflow: "hidden", flexShrink: 0, backgroundColor: "var(--surface-2)", display: "flex", alignItems: "center", justifyContent: "center" }}>
              {imagePreview ? (
            ...
            <div style={{ flex: 1, minWidth: "200px" }}>
              ...
              <div style={{ fontSize: "13px", color: "var(--ink-3)" }}>{form.program || "No program selected"}</div>
          ...
          {/* Tabs */}
          <div style={{ display: "flex", gap: "4px", padding: "0 20px", borderBottom: "1px solid var(--border)", backgroundColor: "var(--surface-2)" }}>
            {tabs.map((tab) => {
              const Icon = tab.icon;
