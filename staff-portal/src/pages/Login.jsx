      ...
      <div className="login">
        ...
        <div className="login-art">
          ...
          <div style={{ position: "relative", zIndex: 1 }}>
            ...
            >
              Manage students, attendance, assessments, fees and staff — built
              for teachers and administrators on Frappe Education.
            </p>
            <div
              style={{
                display: "flex",
            ...
            >
              {[
                [
                  ...
                  "From admission to school term results, in one place.",
                ],
                [
                  CalendarCheck,
                  "Fast daily attendance",
                  "Bulk mark a class in seconds, with a clean history.",
                ],
                [
                  BarChart3,
                  "Real-time insights",
                  "Attendance, performance and fee dashboards, always current.",
                ],
              ].map(([Ic, t, d]) => (
                <div
                  key={t}
          ...
          >
            © {new Date().getFullYear()} School Staff Portal · Built for Frappe
            Education
          </div>
        </div>
