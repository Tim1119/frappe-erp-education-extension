...
const monthLabel = (iso) =>
  new Date(iso).toLocaleString("en", { month: "short" });
...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    frappe
      ...
      .then(setOutstandingFees)
      .catch(() => setOutstandingFees([]));
    ...
    () => [
      {
        ico: GraduationCap,
        tone: "brand",
        value: kpis ? n(kpis.students) : "—",
        label: "Total Students",
      },
      {
        ico: Contact,
        tone: "cyan",
        value: kpis ? n(kpis.teachers) : "—",
        label: "Teachers",
      },
      {
        ico: Users2,
        tone: "purple",
        value: kpis ? n(kpis.groups) : "—",
        label: "Student Groups",
      },
      {
        ico: CalendarCheck,
        tone: "green",
        value: kpis ? `${kpis.attendanceRate}%` : "—",
        label: "Attendance Today",
      },
      {
        ico: ClipboardList,
        tone: "amber",
        value: kpis ? n(kpis.assessments) : "—",
        label: "Assessment Plans",
      },
      {
        ico: Award,
        tone: "brand",
        value: kpis ? n(kpis.results) : "—",
  ...
  return (
    <>
      <PageHeader
        eyebrow="Live from Frappe"
        title="Dashboard"
        sub="A snapshot of today across your school."
      />
      ...
      <div style={{ marginBottom: 18 }}>
        {attendanceTrend == null ? (
          ...
          <AreaCard
            ...
            keys={[
              { dk: "present", color: tk.green },
              { dk: "absent", color: tk.red },
              { dk: "late", color: tk.amber },
            ]}
          />
        )}
      </div>
      ...
      <div className="grid-2" style={{ marginBottom: 18 }}>
        <div className="panel">
          ...
          {timetable == null ? (
            <div className="muted" style={{ padding: "20px 18px" }}>
              Loading…
            </div>
          ) : timetable.length === 0 ? (
      ...
      <div className="grid-2">
        <div className="panel">
          <div className="panel-head">
            <div className="panel-title">Pending leave requests</div>
          </div>
          {pendingLeave == null ? (
            <div className="muted" style={{ padding: "20px 18px" }}>
              Loading…
        ...
        <div className="panel">
          <div className="panel-head">
            <div>
              <div className="panel-title">Outstanding fees</div>
            </div>
