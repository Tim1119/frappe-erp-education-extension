...
frappe.query_reports["Student Birthday Report"] = {
	filters: [
		...
		},
		{
			...
			default: 30,
			depends_on:
				"eval:frappe.query_report.get_filter_value('view_type')=='Upcoming Birthdays'",
		},
		{
			fieldname: "month",
	...
	formatter: function (value, row, column, data, default_formatter) {
		...
		if (
			column.fieldname == "days_until_birthday" &&
			data &&
			data.days_until_birthday > 0 &&
			data.days_until_birthday <= 7
		) {
