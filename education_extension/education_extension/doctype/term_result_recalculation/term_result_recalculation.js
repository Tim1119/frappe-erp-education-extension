    ...
    refresh: function(frm) {
        ...
        if (frm.doc.academic_year && frm.doc.academic_term && frm.doc.assessment_group) {
            frm.add_custom_button(__('Recalculate Results'), () => {
                ...
                frappe.confirm(
                    __('Are you sure you want to recalculate all **School Term Results** for this Term/Year/Group? This may take a while and overwrite existing data.'),
                    () => {
            ...
            frm.dashboard.set_headline(
                __('<p class="text-danger">Please fill in **Academic Year**, **Academic Term**, and **Assessment Group** to enable the Recalculation button.</p>')
            );
        }
    }
});