...
.login-btn:hover:not(:disabled) { background: #333333; }
...
.email-link-btn:hover:not(:disabled) { background: #e5e7eb; }
.email-link-btn:disabled { opacity: 0.4; cursor: not-allowed; }
...
.powered-by strong { color: #6b7280; font-weight: 500; }

/* Transitions */
.fade-down-enter-active { animation: fadeDown 0.3s ease; }
@keyframes fadeDown {
