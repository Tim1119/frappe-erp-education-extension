<template>
  <div style="display: flex; flex-direction: column; gap: 1rem; height: 100%;">
    ...
    <template v-else-if="data.data">
      <div v-if="data.data.enrollment" class="inline-block bg-blue-50 text-blue-700 text-sm font-semibold px-3 py-1.5 rounded-full">
        {{ data.data.enrollment.program }} · {{ data.data.enrollment.academic_year }}
      </div>
      <div style="background:#fff; border:1px solid #e5e7eb; border-radius:12px; overflow:hidden; flex:1;">
