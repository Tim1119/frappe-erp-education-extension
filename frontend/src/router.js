	...
	},
	{
		...
		children: [
			{ path: '', redirect: (to) => `/student/${to.params.studentId}/profile` },
			{
				path: 'attendance',
				name: 'WardAttendance',
				component: () => import('@/pages/ward/WardAttendance.vue'),
			},
			{
				path: 'schedule',
				name: 'WardSchedule',
				component: () => import('@/pages/ward/WardSchedule.vue'),
			},
			{
				path: 'grades',
				name: 'WardGrades',
				component: () => import('@/pages/ward/WardGrades.vue'),
			},
			{
				path: 'fees',
				name: 'WardFees',
				component: () => import('@/pages/ward/WardFees.vue'),
			},
			{
				path: 'report',
				name: 'WardReport',
				component: () => import('@/pages/ward/WardReport.vue'),
			},
			{
				path: 'awards',
				name: 'WardAwards',
				component: () => import('@/pages/ward/WardAwards.vue'),
			},
			{
				path: 'profile',
				name: 'WardProfile',
				component: () => import('@/pages/ward/WardProfile.vue'),
			},
		],
	},
]
